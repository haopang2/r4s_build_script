...
pushd feeds/packages
  ...
  [ "$version" = "snapshots-23.05" ] || [ "$version" = "rc2" ] && rm -rf net/xtables-addons && git clone git@github.com:sbwml/feeds_packages_net_xtables-addons net/xtables-addons
popd
...
pushd feeds/telephony
  ...
  [ "$version" = "snapshots-23.05" ] || [ "$version" = "rc2" ] && rm -rf libs/dahdi-linux && git clone git@github.com:sbwml/feeds_telephony_libs_dahdi-linux libs/dahdi-linux
  # rtpengine
